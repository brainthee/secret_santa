...
class WishList(models.Model):
    participant = models.ForeignKey(
        Participant, related_name="wishlist", on_delete=models.CASCADE
    )
...
class DrawnName(models.Model):
    year = models.IntegerField()
    participant = models.ForeignKey(
        Participant, related_name="draws", on_delete=models.CASCADE
    )
    recipient = models.ForeignKey(
        Participant, related_name="givers", on_delete=models.CASCADE
    )
    ...
    def __str__(self) -> str:
        return "{}: {} -> {}".format(self.year, self.participant, self.recipient)
